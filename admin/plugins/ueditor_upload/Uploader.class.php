...
class Uploader
{
    ...
    public function getFileInfo()
    {
        return array(
            ...
            "name" => $this->fileName ,
            "url" => $this->relPath.'/'.$this->fileName ,
            "size" => $this->fileSize ,
            "type" => $this->fileType ,
    ...
    {
        $pathStr = realpath(dirname(__FILE__)).DIRECTORY_SEPARATOR.'..'.DIRECTORY_SEPARATOR.'..'.DIRECTORY_SEPARATOR.'..'.DIRECTORY_SEPARATOR.'assets/upload/';
        if ( strrchr( $this->config[ "savePath" ], "/" ) != "/" ) {
            $this->config[ "savePath" ] .= "/";
        }
		$dataFolder = date( "Ymd" );
		$this->relPath = $this->config[ "savePath" ].$dataFolder;
        $pathStr .= $this->relPath;
