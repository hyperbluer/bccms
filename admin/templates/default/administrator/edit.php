...
<div class="modal-body">
    ...
    <div class="form">
    <!-- BEGIN FORM-->
	<form action="<?php echo _url('administrator/index/edit', array('id'=>$item['user_id']));?>" id="form_add" class="form-horizontal form-bordered form-row-stripped" method="post">
        <div class="control-group">
            <label class="control-label" for="input_username">用户名</label>
            <div class="controls">
                <input name="username" id="input_username" value="<?php echo $item['username']?>" type="text" placeholder="" class="" disabled readonly/>
        ...
        <div class="control-group">
            ...
            <div class="controls">
                <input name="nickname" id="input_nickname" value="<?php echo $item['nickname']?>" type="text" placeholder="" class="m-wrap" />
                <span class="help-inline"></span>
            </div>
        </div>
        <div class="control-group">
            ...
            <div class="controls">
                <input name="password" id="input_password" value="" type="password" placeholder="" class="m-wrap" />
                <span class="help-inline"></span>
            </div>
        </div>
        <div class="control-group">
            <label class="control-label" for="input_password_confirm">确认密码</label>
            <div class="controls">
                <input name="password_confirm" id="input_password_confirm" value="" type="password" placeholder="" class="m-wrap" />
                <span class="help-inline"></span>
            </div>
        </div>
        <div class="control-group">
            ...
            <div class="controls">
                <input name="email" id="input_email" value="<?php echo $item['email']?>" type="text" placeholder="" class="m-wrap" />
                <span class="help-inline"></span>
            </div>
        </div>
        <div class="control-group">
            ...
            <div class="controls">
                <select class="m-wrap" name="role_id" id="input_role_id">
                    ...
                    <option value="<?php echo $v['role_id'];?>" <?php if ($item['role_id'] == $v['role_id']):?>selected="selected"<?php endif;?>><?php echo $v['name'];?></option>
                    <?php endforeach;?>
                </select>
                <span class="help-inline"></span>
            </div>
