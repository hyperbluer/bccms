					...
					<div class="span6 responsive" data-tablet="span12 fix-offset" data-desktop="span6">
						...
						<div class="portlet box grey">
							<div class="portlet-title">
								<div class="caption"><i class="icon-list"></i>语言版本列表</div>
								<div class="actions">
									<a href="#" class="btn green" onclick="operate.ajaxModal($(this));" data-toggle="modal" data-url="<?php echo _url('language/index/add');?>"><i class="icon-plus"></i> 添加</a>
								</div>
							</div>
							<div class="portlet-body">
								<table class="table table-striped table-bordered table-hover" id="table_managed_2">
									...
									<tbody>
										...
										<tr class="odd gradeX">
											<td><input type="checkbox" class="checkboxes" value="<?php echo $item['language_id'];?>" /></td>
											<td><?php echo $item['name'];?></td>
											<td><?php echo $item['code'];?></td>
											<td><?php echo $item['locale'];?></td>
											<td><img src="<?php echo ASSETS_PATH.'img/flags/'.$item['image'];?>" /></td>
                                            ...
                                            <td>
                                                <a href="#" class="btn mini blue" onclick="operate.ajaxModal($(this));" data-toggle="modal" data-url="<?php echo _url('language/index/edit', array('id' => $item['language_id']));?>"><i class="icon-edit"></i> 编辑</a>
                                                <a href="#" class="btn mini black" onclick="operate.deleteModal($(this));" data-url="<?php echo _url('language/index/delete', array('id' => $item['language_id']));?>"><i class="icon-trash"></i> 删除</a>
                                            </td>
										</tr>
                                        <?php endforeach;?>
									</tbody>
