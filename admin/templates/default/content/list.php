					...
					<div class="span6 responsive" data-tablet="span12 fix-offset" data-desktop="span6">
						...
						<div class="portlet box grey">
							<div class="portlet-title">
								<div class="caption"><i class="icon-list"></i>内容列表</div>
								<div class="actions">
									<a href="<?php echo _url('content/form/add', array('category_id'=>$_categoryId))?>" class="btn green"><i class="icon-plus"></i> 添加</a>
								</div>
							</div>
							<div class="portlet-body">
								<table class="table table-striped table-bordered table-hover" id="table_managed_2">
									...
									<tbody>
										...
										<tr class="odd gradeX">
											<td><input type="checkbox" class="checkboxes" value="<?php echo $item['content_id'];?>" /></td>
											<td><?php echo $item['title'];?></td>
											<td><?php echo Date::format(null, $item['add_time']);?>
                                            </td>
                                            ...
                                            <td>
                                                <a href="<?php echo _url('content/form/edit', array('id' => $item['content_id'], 'category_id' => $item['category_id'], 'menu_id' => $_menuId));?>" class="btn mini blue"><i class="icon-edit"></i> 编辑</a>
                                                <a href="#" class="btn mini black" onclick="operate.deleteModal($(this));" data-url="<?php echo _url('content/form/delete', array('id' => $item['content_id'], 'category_id' => $item['category_id']));?>"><i class="icon-trash"></i> 删除</a>
                                            </td>
										</tr>
                                        <?php endforeach;?>
									</tbody>
								</table>
								<div class="row-fluid paging_bootstrap pagination">
									<? echo $pages;?>
								</div>
							</div>
						</div>
...
<link rel="stylesheet" href="/bc/assets/plugins/data-tables/DT_bootstrap.css"/>
