...
<div class="modal-body">
    ...
    <div class="form">
    <!-- BEGIN FORM-->
	<form action="<?php echo _url('menu/index/edit', array('id'=>$item['menu_id']));?>" id="form_edit" class="form-horizontal form-bordered form-row-stripped" method="post">
        ...
        <div class="control-group">
            ...
            <div class="controls">
                <select class="m-wrap" name="parent_id" id="input_parent_id">
                    ...
                    <option value="<?php echo  $node->id;?>"  <?php if ($item['parent_id'] == $node->id):?>selected="selected"<?php endif;?> ><?php echo $node->name;?></option>
                        <?php if (is_array($node->children) && count($node->children)):?>
                        <?php foreach ($node->children as $k => $nodeSecond):?>
                            <option value="<?php echo $nodeSecond->id;?>"  <?php if ($item['parent_id'] == $nodeSecond->id):?>selected="selected"<?php endif;?> >&nbsp;&nbsp;- <?php echo $nodeSecond->name;?></option>
                        <?php endforeach;?>
                        <?php endif;?>
                    <?php endforeach;?>
                </select>
        ...
        <div class="control-group">
            ...
            <div class="controls">
                <input name="url" id="input_url" value="<?php echo $item['url'];?>" type="text" placeholder="" class="m-wrap" value="#"/>
        ...
        <div class="control-group">
            ...
            <div class="controls">
                <input name="params" id="input_params" value="<?php echo $item['params'];?>" type="text" placeholder="" class="m-wrap" />
