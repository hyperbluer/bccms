    ...
    <div class="span12">
        <div class="portlet box blue">
            <div class="portlet-title">
                <div class="caption"><i class="icon-list"></i>后台菜单</div>
            </div>
            <div class="portlet-body ">
                <div class="clearfix">
				    <div class="btn-group">
                        <button onclick="operate.ajaxModal($(this));" data-toggle="modal" class="btn green" data-url="<?php echo _url('menu/index/add');?>">
                ...
                <div class="dd" id="nestable_list_admin_menu">
                    <ol class="dd-list">
                        <?php foreach ($menuTree as $k => $node):?>
                        <li class="dd-item" data-id="<?php echo $node->id;?>">
                            <div class="dd-handle"><?php echo $node->name;?> <?php if (!$node->status):?><span class="label label-important">不显示</span><?php endif;?>
                                <div class="dd-nodrag btn-group pull-right">
                                    <a href="#" class="btn mini blue" onclick="operate.ajaxModal($(this));" data-toggle="modal" data-url="<?php echo _url('menu/index/edit', array('id' => $node->id));?>"><i class="icon-edit"></i> 编辑</a>
                                    <a href="#" class="btn mini black"  onclick="operate.deleteModal($(this));" data-url="<?php echo _url('menu/index/delete', array('id' => $node->id));?>"><i class="icon-trash"></i> 删除</a>
                                </div>
                            </div>
                            ...
                            <ol class="dd-list">
                                ...
                                <li class="dd-item" data-id="<?php echo $nodeSecond->id;?>">
                                    <div class="dd-handle"><?php echo $nodeSecond->name;?> <?php if (!$nodeSecond->status):?><span class="label label-important">不显示</span><?php endif;?>
                                    <div class="dd-nodrag btn-group pull-right">
                                        <a href="#" class="btn mini blue" onclick="operate.ajaxModal($(this));" data-url="<?php echo _url('menu/index/edit', array('id' => $nodeSecond->id));?>"><i class="icon-edit"></i> 编辑</a>
                                        <a href="#" class="btn mini black" onclick="operate.deleteModal($(this));" data-url="<?php echo _url('menu/index/delete', array('id' => $nodeSecond->id));?>"><i class="icon-trash"></i> 删除</a>
                                    </div>
                                    </div>
                                    ...
                                    <ol class="dd-list">
                                        ...
                                        <li class="dd-item" data-id="<?php echo $nodeThree->id;?>">
                                            <div class="dd-handle"><?php echo $nodeThree->name;?> <?php if (!$nodeThree->status):?><span class="label label-important">不显示</span><?php endif;?>
                                                <div class="dd-nodrag btn-group pull-right">
                                                    <a href="#" class="btn mini blue" onclick="operate.ajaxModal($(this));" data-url="<?php echo _url('menu/index/edit', array('id' => $nodeThree->id));?>"><i class="icon-edit"></i> 编辑</a>
                                                    <a href="#" class="btn mini black"  onclick="operate.deleteModal($(this));" data-url="<?php echo _url('menu/index/delete', array('id' => $nodeThree->id));?>"><i class="icon-trash"></i> 删除</a>
                                                </div>
                                            </div>
                                        </li>
                                        <?php endforeach;?>
