	...
	<div class="span12">
        <div class="portlet box blue">
		    <div class="portlet-title">
		        <div class="caption"><i class="icon-reorder"></i>编辑链接</div>
		    </div>
		    <div class="portlet-body form">
                <!-- BEGIN FORM-->
				<form action="<?php echo _url('link/index/edit', array('id' => $item['link_id']))?>" id="form_edit" class="form-horizontal form-bordered form-row-stripped" method="post"  enctype="multipart/form-data">
                <div class="control-group">
					<label class="control-label" for="input_sitename">站点名称 <span class="required">*</span></label>
					<div class="controls">
						<input name="info[sitename]" id="input_sitename" value="<?php echo $item['sitename'];?>" type="text" placeholder="" class="m-wrap" />
				...
				<div class="control-group">
					...
					<div class="controls">
						<input name="info[website]" id="input_website" value="<?php echo $item['website'];?>" type="text" placeholder="" class="m-wrap" />
						<span class="help-inline"></span>
					</div>
				</div>
				<div class="control-group">
					...
					<div class="controls">
						...
						<div class="fileupload-new thumbnail" style="width: 200px;">
							<img src="<?php echo UPLOAD_PATH.'images/'.$item['logo'];?>" alt="" style="width: 200px;">
						</div>
						<br /> 
						<?php endif;?>
				...
				<div class="control-group">
					...
					<div class="controls">
						<input name="info[email]" id="input_email" value="<?php echo $item['email'];?>" type="text" placeholder="" class="m-wrap" />
						<span class="help-inline"></span>
					</div>
				</div>
				<div class="control-group">
