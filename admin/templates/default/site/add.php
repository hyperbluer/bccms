...
<div class="modal-body">
    ...
    <div class="form">
    <!-- BEGIN FORM-->
	<form action="<?php echo _url('site/index/add')?>" id="form_add" class="form-horizontal form-bordered form-row-stripped" method="post">
        ...
        <div class="control-group">
            ...
            <div class="controls">
                <input name="keywords" id="input_keywords" type="text" placeholder="" class="m-wrap"/>
                <span class="help-inline"></span>
            </div>
        </div>
        <div class="control-group">
