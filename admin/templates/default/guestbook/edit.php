	...
	<div class="span12">
        <div class="portlet box blue">
		    <div class="portlet-title">
		        <div class="caption"><i class="icon-reorder"></i>编辑留言板</div>
		    </div>
		    <div class="portlet-body form">
                <!-- BEGIN FORM-->
                <form action="<?php echo _url('guestbook/index/edit', array('id' => $item['guestbook_id']))?>" id="form_add" class="form-horizontal form-bordered form-row-stripped" method="post"  enctype="multipart/form-data">
                <div class="control-group">
					<label class="control-label" for="input_guestname">昵称</label>
					<div class="controls">
						<input name="info[guestname]" id="input_guestname" value="<?php echo $item['guestname'];?>" type="text" placeholder="" readonly disabled/>
				...
				<div class="control-group">
					...
					<div class="controls">
						<input name="info[email]" id="input_email" value="<?php echo $item['email'];?>"  type="text" placeholder="" readonly disabled/>
						<span class="help-inline"></span>
					</div>
				</div>
				<div class="control-group">
					...
					<div class="controls">
						<input name="info[tel]" id="input_tel" value="<?php echo $item['tel'];?>"  type="text" placeholder="" readonly disabled/>
						<span class="help-inline"></span>
					</div>
				</div>
				<div class="control-group">
					...
					<div class="controls">
						<input name="info[mobile]" id="input_mobile" value="<?php echo $item['mobile'];?>"  type="text" placeholder="" readonly disabled/>
						<span class="help-inline"></span>
					</div>
				</div>
				<div class="control-group">
					...
					<div class="controls">
						<input name="info[address]" id="input_address" value="<?php echo $item['address'];?>"  type="text" placeholder="" readonly disabled/>
						<span class="help-inline"></span>
					</div>
				</div>
				<div class="control-group">
					...
					<div class="controls">
						<input name="info[add_time]" id="input_add_time" value="<?php echo Date::format(null, $item['add_time']);?>"  type="text" placeholder="" readonly disabled/>
						<span class="help-inline"></span>
					</div>
				</div>
				<div class="control-group">
					...
					<div class="controls">
						<textarea name="info[content]" id="input_content" placeholder="" class="large m-wrap"><?php echo $item['content'];?></textarea>
						<span class="help-inline"></span>
					</div>
				</div>
				<div class="control-group">
					<label class="control-label" for="input_reply_content">回复内容</label>
					<div class="controls">
						<textarea name="reply[content]" id="input_reply_content" placeholder="" class="large m-wrap"><?php if (isset($replyItem['content'])) echo $replyItem['content'];?></textarea>
						<span class="help-inline"></span>
					</div>
				</div>
				<?php if (isset($replyItem['add_time'])):?>
				<div class="control-group">
					<label class="control-label" for="input_reply_add_time">回复时间</label>
					<div class="controls">
						<input name="reply[add_time]" id="input_reply_add_time" value="<?php echo Date::format(null, $replyItem['add_time']);?>"  type="text" placeholder="" readonly disabled/>
						<span class="help-inline"></span>
					</div>
				</div>
				<?php endif;?>
