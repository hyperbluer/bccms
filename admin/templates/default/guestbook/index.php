					...
					<div class="span6 responsive" data-tablet="span12 fix-offset" data-desktop="span6">
						...
						<div class="portlet box grey">
							<div class="portlet-title">
								<div class="caption"><i class="icon-list"></i>留言列表</div>
								<div class="actions">
									<a href="<?php echo _url('guestbook/index/add');?>" class="btn green"><i class="icon-plus"></i> 添加</a>
								</div>
							</div>
							<div class="portlet-body">
								<table class="table table-striped table-bordered table-hover" id="table_managed_2">
									...
									<tbody>
										...
										<tr class="odd gradeX">
											<td><input type="checkbox" class="checkboxes" value="<?php echo $item['guestbook_id'];?>" /></td>
											<td><?php echo $item['guestname'];?></td>
                                            ...
                                            <td>
                                                <a href="<?php echo _url('guestbook/index/edit', array('id' => $item['guestbook_id']));?>" class="btn mini blue" ><i class="icon-edit"></i> 编辑</a>
                                                <a href="#" class="btn mini black" onclick="operate.deleteModal($(this));" data-url="<?php echo _url('guestbook/index/delete', array('id' => $item['guestbook_id']));?>"><i class="icon-trash"></i> 删除</a>
                                            </td>
										</tr>
                                        <?php endforeach;?>
									</tbody>
