	...
	<div class="span12">
        <div class="portlet box blue tabbable">
		    ...
		    <div class="portlet-body form">
                <!-- BEGIN FORM-->
                <form action="<?php echo _url('role/index/add')?>" id="form_add" class="form-horizontal form-bordered form-row-stripped" method="post">
                            ...
                            <div class="control-group">
                                ...
                                <div class="controls">
                                    <select multiple="multiple" id="multi_select_1" name="info[sites][]">
                                        ...
                                        <option value="<?php echo $v['site_id'];?>"><?php echo $v['name'];?></option>
                                        <?php endforeach;?>
                                    </select>
                                    <span class="help-inline"></span>
                                </div>
                                        ...
                                        <optgroup label="<?php echo $module;?>">
                                            <?php foreach($controllers as $controller => $actions):?>
                                                <?php foreach($actions as $k => $action):?>
										            <option value="<?php echo $module.'/'.$controller.'/'.$action;?>"><?php echo $module.'/'.$controller.'/'.$action;?></option>
                                                <?php endforeach;?>
                                            <?php endforeach;?>
										</optgroup>
                                        <?php endforeach;?>
