					...
					<div class="span6 responsive" data-tablet="span12 fix-offset" data-desktop="span6">
						...
						<div class="portlet box grey">
							<div class="portlet-title">
								<div class="caption"><i class="icon-list"></i>模型列表</div>
								<div class="actions">
									<a href="#" class="btn green" onclick="operate.ajaxModal($(this));" data-toggle="modal" data-url="<?php echo _url('model/index/add');?>"><i class="icon-plus"></i> 添加</a>
								</div>
							</div>
							<div class="portlet-body">
								<table class="table table-striped table-bordered table-hover" id="table_managed_2">
									...
									<tbody>
										...
										<tr class="odd gradeX">
											<td><input type="checkbox" class="checkboxes" value="<?php echo $item['model_id'];?>" /></td>
                                            ...
                                            <td>
                                                <a href="<?php echo _url('model/field', array('model_id' => $item['model_id']));?>" class="btn mini yellow"><i class="icon-edit"></i> 字段管理</a>
                                                <a href="#" class="btn mini blue" onclick="operate.ajaxModal($(this));" data-toggle="modal" data-url="<?php echo _url('model/index/edit', array('id' => $item['model_id']));?>"><i class="icon-edit"></i> 编辑</a>
                                                <a href="#" class="btn mini black" onclick="operate.deleteModal($(this));" data-url="<?php echo _url('model/index/delete', array('id' => $item['model_id']));?>"><i class="icon-trash"></i> 删除</a>
                                            </td>
										</tr>
                                        <?php endforeach;?>
									</tbody>
