	...
	<div class="span12">
        <div class="portlet box blue">
		    <div class="portlet-title">
		        <div class="caption"><i class="icon-reorder"></i>添加广告位</div>
		    </div>
		    <div class="portlet-body form">
                <!-- BEGIN FORM-->
				<form action="<?php echo _url('ads/position/add')?>" id="form_add" class="form-horizontal form-bordered form-row-stripped" method="post"  enctype="multipart/form-data">
				...
				<div class="control-group">
					...
					<div class="controls">
						<input name="info[width]" id="input_width" type="text" placeholder="" class="m-wrap small" />
						<span class="help-inline"></span>
					</div>
				</div>
				<div class="control-group">
					...
					<div class="controls">
						<input name="info[height]" id="input_height" type="text" placeholder="" class="m-wrap small" />
						<span class="help-inline"></span>
					</div>
				</div>
				<div class="control-group">
