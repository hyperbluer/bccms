					...
					<div class="span6 responsive" data-tablet="span12 fix-offset" data-desktop="span6">
						...
						<div class="portlet box grey">
							<div class="portlet-title">
								...
								<div class="actions">
									<a href="<?php echo _url('ads/index/add', array('ads_position_id'=> $ads_position_id));?>" class="btn green"><i class="icon-plus"></i> 添加</a>
								</div>
							</div>
							<div class="portlet-body">
								<table class="table table-striped table-bordered table-hover" id="table_managed_2">
									...
									<tbody>
										...
										<tr class="odd gradeX">
											<td><input type="checkbox" class="checkboxes" value="<?php echo $item['ads_id'];?>" /></td>
											<td><?php echo $item['name'];?></td>
											<td><?php echo $typeList[$item['type']];?></td>
                                            ...
                                            <td>
                                                <a href="<?php echo _url('ads/index/edit', array('id' => $item['ads_id']));?>" class="btn mini blue" ><i class="icon-edit"></i> 编辑</a>
                                                <a href="#" class="btn mini black" onclick="operate.deleteModal($(this));" data-url="<?php echo _url('ads/index/delete', array('id' => $item['ads_id']));?>"><i class="icon-trash"></i> 删除</a>
                                            </td>
										</tr>
                                        <?php endforeach;?>
									</tbody>
