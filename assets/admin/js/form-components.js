var FormComponents = function () {
    ...
    var handleToggleButtons = function () {
        ...
        $('.text-toggle-button').toggleButtons({
            width: 200,
            label: {
                enabled: $('.text-toggle-button').attr('data-enabled'),
                disabled: $('.text-toggle-button').attr('data-disabled')
            }
        });
	...
	var handleUEditor = function (options) {
        if (!window.UE) {
            return;
        }
		...
		if (!options) {
			var options = {
				...
				imageUrl:EXT_PATH+"ueditor_upload/imageUp.php",
				imagePath:UPLOAD_PATH,
				scrawlUrl:EXT_PATH+"ueditor_upload/scrawlUp.php",  
				scrawlPath:UPLOAD_PATH,
				fileUrl:EXT_PATH+"ueditor_upload/fileUp.php",
				filePath:UPLOAD_PATH,
				catcherUrl:EXT_PATH +"ueditor_upload/getRemoteImage.php",
				catcherPath:UPLOAD_PATH,
				imageManagerUrl:EXT_PATH + "ueditor_upload/imageManager.php",
				imageManagerPath:UPLOAD_PATH,
				wordImageUrl:EXT_PATH + "ueditor_upload/imageUp.php",
				wordImagePath:UPLOAD_PATH,  
				getMovieUrl:EXT_PATH+"ueditor_upload/getMovie.php",
